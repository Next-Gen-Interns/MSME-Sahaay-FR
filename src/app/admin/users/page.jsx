...
const UserManagement = () => {
  ...
  const getRoleBadge = (role) => {
    const roleConfig = {
      buyer: {
        color: "bg-[var(--color-accent-100)] text-[var(--color-accent-800)]",
        label: "Buyer",
      },
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          ...
          className="mt-4 sm:mt-0 inline-flex items-center px-4 py-2 bg-[var(--color-accent-600)] text-white rounded-xl hover:bg-[var(--color-accent-700)] transition-colors duration-200"
        >
          <svg
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[var(--color-accent-500)] focus:border-[var(--color-accent-500)]"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <select
              ...
              className="px-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[var(--color-accent-500)] focus:border-[var(--color-accent-500)]"
            >
          ...
          <div className="mt-4 flex flex-col sm:flex-row sm:items-center gap-4 p-4 bg-gray-50 rounded-xl">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button
                ...
                disabled={!bulkAction}
                className="px-4 py-1 bg-[var(--color-accent-600)] text-white rounded-lg text-sm hover:bg-[var(--color-accent-700)] disabled:bg-gray-400 disabled:cursor-not-allowed"
              >
                Apply
              </button>
              <button
              ...
              <tr>
                <th className="px-6 py-4 text-left">
                  <input
                    ...
                    className="rounded border-gray-300 text-[var(--color-accent-600)] focus:ring-[var(--color-accent-500)]"
                  />
                </th>
                ...
                <tr key={user.user_id} className="hover:bg-gray-50">
                    ...
                    <div className="flex items-center">
                      <div className="flex-shrink-0 h-10 w-10">
                        {user?.avatar_url ? (
                          ...
                          <div className="h-10 w-10 rounded-full bg-gradient-to-r from-[var(--color-accent-500)] to-purple-600 flex items-center justify-center text-white font-bold text-lg shadow-md">
                  ...
                  <td className="px-6 py-4">
                    <select
                      ...
                      className={`text-sm border-0 rounded-lg focus:ring-2 focus:ring-[var(--color-accent-500)] ${
                        user.status === "active"
                  ...
                  <td className="px-6 py-4 text-sm font-medium">
                    <div className="flex items-center space-x-2">
                      <button
                        ...
                        className="text-[var(--color-accent-600)] hover:text-[var(--color-accent-900)]"
                      >
                        Edit
                      </button>
                      <button
