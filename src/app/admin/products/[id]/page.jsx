                ...
                {listing.listing_media.map((media, index) => (
                  <button
                    ...
                    className={`flex-shrink-0 w-20 h-20 rounded-lg overflow-hidden border-2 transition-all duration-200 ${
                      selectedImage === index
                        ? "border-[var(--color-accent-500)] ring-2 ring-[var(--color-accent-200)]"
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-white/20 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <p className="text-gray-900 font-medium">
                  {listing.estimated_timeline || "N/A"}
                </p>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {listing.service_cities?.map((area, index) => (
                    <span
                      key={index}
                      className="inline-flex items-center px-3 py-1 bg-[var(--color-accent-100)] text-[var(--color-accent-800)] rounded-full text-sm font-medium border border-[var(--color-accent-200)]"
                    >
                      {area}
                    </span>
                  )) || (
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-white/20 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-gray-900 font-medium">
                  {listing.seller?.business_name || "N/A"}
                </p>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
