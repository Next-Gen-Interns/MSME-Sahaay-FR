          ...
          <>
            ...
            >
              {infiniteListings.map((listing, index) => (
                <div
                  key={index}
                  className="flex-shrink-0 w-[85%] sm:w-[46%] lg:w-[23%] bg-white border border-gray-200 rounded-sm hover:shadow-md hover:border-[var(--color-accent-300)] transition-all duration-200 overflow-hidden group"
                >
