...
const FlipCard = ({ listing, router }) => {
  ...
  return (
    <div className="relative w-full h-[420px] perspective-1000">
      ...
      {/* Card */}
      <motion.div
        className="relative w-full h-full rounded-xs preserve-3d"
        animate={{ rotateY: isFlipped ? 180 : 0 }}
      ...
      >
        ...
        <div
          className="
            ...
            bg-gray-50 rounded-xs shadow-lg
            border border-gray-200
          "
        >
          <div className="p-4 h-full flex flex-col">
            ...
            {/* Price */}
            <div className="bg-white-600 text-gray-900 p-3 rounded-xs mb-3">
              <p className="text-xl font-bold">
                {listing.price || "₹0"}
                <span className="text-sm ml-1">/service</span>
              </p>

              <p className="text-xs opacity-90">All taxes included</p>
            </div>
            ...
            <div className="mt-auto">
              <motion.button
                className="
                  w-full bg-[var(--color-accent-800)] hover:bg-[var(--color-accent-900)]
                  text-white font-semibold py-2.5 rounded-xs
        ...
        <section className="relative h-64 sm:h-80 overflow-hidden">
          ...
          <div className="relative h-full flex items-center justify-center text-white text-center px-4">
            <div>
              ...
              <p className="text-lg opacity-90">{subcategoryData.category}</p>
            </div>
          </div>
        </section>
      )}
          ...
          >
            <AnimatePresence>
              {listings.map((listing, index) => (
                ...
                >
                  <FlipCard listing={listing} router={router} />
                </motion.div>
              ))}
            </AnimatePresence>
          </div>
